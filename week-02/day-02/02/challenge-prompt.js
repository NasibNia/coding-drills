...
for (var i = 0; i < numArray.length; i++) {
  if ( numArray[i] === 11 ) {
    indexOf11.push(i);
    alert(" 11 happened at index " + i );
  }  
}
alert(" 11 happened at index " + indexOf11 );
...
console.log("the sum of all numbers greater than 50 is " + sum);
...
console.log("the number of times Apple occured in the string is " + count);
...
console.log("the number of times Peach occured in the string is " + count);
...
console.log("the number of fruits that start with 'P' is " + count);

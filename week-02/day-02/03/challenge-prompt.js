...
Your Answer here
we need to call the function in order it to be executed
*/
...
function goodDay() {
    var responce = confirm ("are you having a nice day?");
    log(responce);
}
...
function userPopUp() {
    var ans = confirm("would you like a popup?");
    if ( ans ) {
        popUp();
    } else {
        noPopUp();
...
function favoriteFruit () {
    var ans = prompt("your favorite fruit?");
    alert(ans);
}

...
var ageAtPassing;
ageAtPassing = deathYear-birthYear;
...
var statementThree = "In " + yearOfPublish + " she published the first Algorithm, the "+ firstAlgorithm + ", at the age of " + (yearOfPublish - birthYear) +".";
...
var statementFour = "She was a " + nationality +  " Citizen who lived in " + cityLocation + ", " + countryLocation +  " until her passing in " + deathYear +  " at the age of "+ (deathYear-birthYear) +".";

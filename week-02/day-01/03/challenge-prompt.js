...
var forSandwich = confirm ("are you here for a sandwich? ");
...
// if question is equal to true
    ...
    if (forSandwich) {
        var whatKind = prompt("what kind of sandwich would you like ?");
        document.write(welcomePrompt +"\n please wait 10 min for your with another variable of foodPrompt");
    } else {

...
$(function() {
  ...
  localStorage.setItem("localBtn",buttonColors);
  localStorage.getItem("localBtn");
  ...
  $(document).on("click", ".user-card", function(event) {
    ...
    var currentState = buttonColors[index];
   ...
   buttonColors = replaceChar(buttonColors, index, currentState);
    console.log(buttonColors);

    localStorage.setItem("localBtn",buttonColors);
    // console.log(localStorage.getItem("localBtn"));
